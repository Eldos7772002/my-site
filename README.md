...
<div  class="float-block">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
                ...
                <a class="dropdown-item" href="#testimonials">Cпециальности </a>
...
<div class="welcome-area" id="welcome">
 ...
 <section class="section home-feature">
        <div class="img2"><img src="https://static.wixstatic.com/media/9427c1_c98d3a9c65c148338de63dfd23a013a8~mv2.gif" width="310" height="150" style="float:  right   ;margin-top: 200px; margin-right: 45px; margin-bottom: -100px;"> </div>
       ...
       <div class="containe2">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                           <div class="features-small-item">
                               <div class="icon">
                                   <i><img src="https://i.ibb.co/0Xgp8xR/good-quality.png" width="60" ></i>
                               </div>
                               <h5 class="features-title" >ОБЩЕЖИТИЕ ПОЛИТЕХНИЧЕСКОГО КОЛЛЕДЖА</h5>
                               <img src="https://ic.wampi.ru/2021/05/18/WhatsApp-Image-2021-05-18-at-16.13.04.jpg" width="760" height="600">
                           </div>
                       </div></div>
                  </div>    
   </section>  
   <section class="section home-feature2">
    <div class="img2"><img src="https://static.wixstatic.com/media/9427c1_c98d3a9c65c148338de63dfd23a013a8~mv2.gif" width="310" height="150" style="float:  left; margin-left: 100px;   ;margin-top: 450px; margin-bottom: -100px;">
       <div class="containe3">
        <div class="row_"> 
        <div class="col-lg-40 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                           <div class="features-small-item2">
                               <div class="icon">
                                   <i><img src="https://i.ibb.co/ChjkyV7/cover.jpg" width="55" ></i>
                               </div>
                               <h5 class="features-title" >ОБЩЕЖИТИЕ ПОЛИТЕХНИЧЕСКОГО КОЛЛЕДЖА</h5>
                               <img src="https://ic.wampi.ru/2021/05/18/WhatsApp-Image-2021-05-18-at-15.55.07-1.jpg" width="700" height="600">
                           </div>
                       </div></div>
                  </div>
   </section>  
   <div class="welcome-area2">
    ...
    <section class="section home-feature3"><p>ВЫБЕРИТЕ КОМНАТУ  </p><p style="font-size: 28px;"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Red_flag.svg/1200px-Red_flag.svg.png" width="25px" height="25px">-забронированно</p><p style="font-size: 28px; margin-left: -89px;"><img src="https://www.solidbackgrounds.com/images/2560x1440/2560x1440-india-green-solid-color-background.jpg" width="25px" height="25px">- свободно</p>
        <div class="dormentory"><a  href="register\1\cab.php"  onclick="<?php $_SESSION['number'] = 1;?>"  ><div class="cab1" id="cab1" >Ком\1<hr style=" margin: 5px; height: 30px; width: 1px;border-color: black; transform: rotate(45deg); background-color: black; margin-left:53px; margin-top: 145px;"></div></a>
    <div class="cab2"  ><h5><hr style="margin-top: -15px;"  ><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr></h5></div>
            <a  href="register\2\cab.php" >
 <div class="cab3" title="<?php echo $text; ?>"><h5 style="position: absolute; top: -10%; text-indent: 10px;">Ком\2<hr style=" margin: 5px; height: 30px; width: 1px;border-color:   black; transform: rotate(45deg); background-color: black; margin-left:50px; margin-top: 145px;"></h5></div></a>
    <a href="register\3\cab.php"><div class="cab4"><h5>Ком\3<hr style=" margin: 5px; height: 30px; width: 1px; border-color:    black;transform: rotate(45deg); background-color: black; margin-left:40px; margin-top: 148px;"></h5></div></a>
        <a href="register\4\cab.php"><div class="cab5"><h5>Ком\4<hr style=" margin: 5px; height: 30px; width: 1px; border-color:    black;transform: rotate(45deg); background-color: black; margin-left:35px; margin-top:68px;"></h5></div></a>
        <a href="register\5\cab.php">
        <div class="cab6"><h5>Ком\5<hr style=" margin: 5px; height: 30px; width: 1px; border-color:     black;transform: rotate(45deg); background-color: black; margin-left:70px; margin-top:118px;"></h5></div></a>
    ...
    <a href="register\2.4\cab.php"><div class="cab24"><h5>Ком\3<hr style=" margin: 5px; height: 30px; width: 1px; border-color:    black;transform: rotate(45deg); background-color: black; margin-left:40px; margin-top: 148px;"></h5></div></a>
       ...
       <a href="register\2.6\cab.php"> <div class="cab26"><h5>Ком\5<hr style=" margin: 5px; height: 30px; width: 1px; border-color:     black;transform: rotate(45deg); background-color: black; margin-left:70px; margin-top:118px;"></h5></div></a>
        ...
        <hr style=" margin: 5px; height: 3px; width: 170px; border-color: black ;background-color: black; margin-top: -475px; margin-left: 470px;">
            <a href="register\2.8\cab.php"><div class="cab28"><h5 style="text-indent: 10px;  line-height:180px; ">Ком\7<hr style=" margin: 5px; height: 30px; width: 1px; border-color:     black;transform: rotate(45deg); background-color: black; margin-left:35px; margin-top:-188px;"></h5></div></a>
    ...
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSf5_At-aiRe5d6Eg4Rps3FnbGNmXyt42vW6dx5MYzn8FI14JA/viewform?usp=pp_url&entry.52440877=1+%D1%8D%D1%82%D0%B0%D0%B6&entry.1611042011=4+%D0%BA%D0%B0%D0%B1"><div class="cab4"><h5>Ком\4<hr style=" margin: 5px; height: 30px; width: 1px; border-color:    black;transform: rotate(45deg); background-color: black; margin-left:40px; margin-top: 148px;"></h5></div></a>
        ...
        <div class="cab8"><h5 style="text-indent: 10px;  line-height:180px; ">Ком\8<hr style=" margin: 5px; height: 30px; width: 1px; border-color:     black;transform: rotate(45deg); background-color: black; margin-left:35px; margin-top:-188px;"></h5></div></a>
         ...
         <div class="cab11"><h5 style="text-indent: 10px;  line-height:180px;">Ком\11<hr style=" margin: 5px; height: 30px; width: 1px; border-color:   black;transform: rotate(45deg); background-color: black; margin-left:35px; margin-top:-188px;"></h5></div></a>
